...
/**
自定义配置
！！！！！若使用iCloud存储缓存文件，请在运行脚本前，手动在iCloud Drive的Scriptable文件夹中手动建立Cache文件夹
*/
...
async function setupWeatherAlert() {
  ...
  alertTitleRaw = (typeof weatherAlert.alert.content[0] !== "undefined") ? weatherAlert.alert.content[0].title : ""
